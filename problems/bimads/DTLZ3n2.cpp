...
/*                  DTLZ3n2                */
/*----------------------------------------*/
class DTLZ3n2 : public Multi_Obj_Evaluator
{

public:
  DTLZ3n2(const NOMAD::Parameters &p) : NOMAD::Multi_Obj_Evaluator(p) {}
...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    p.set_HISTORY_FILE("DTLZ3n2_bimads.txt");
    p.set_STATS_FILE("test_DTLZ3n2.txt", "BBE OBJ");
