...
/*               Deb512a                  */
/*----------------------------------------*/
class Deb512a : public NOMAD::Multi_Obj_Evaluator
{

public:
  Deb512a(const NOMAD::Parameters &p) : NOMAD::Multi_Obj_Evaluator(p) {}
...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    p.set_HISTORY_FILE("Deb512a_bimads.txt");
    p.set_STATS_FILE("test_Deb512a.txt", "BBE OBJ");
