...
/*               Far1                    */
/*----------------------------------------*/
class Far1 : public Multi_Obj_Evaluator
{
public:
  Far1(const NOMAD::Parameters &p) : Multi_Obj_Evaluator(p) {}
  ...
  {
    NOMAD::Double f1 = -2 * exp(15 * (-(x[0].value() - 0.1) * (x[0].value() - 0.1) - x[1].value() * x[1].value())) 
      - exp(20 * (-(x[0].value() - 0.6) * (x[0].value() - 0.6) - (x[1].value() - 0.6) * (x[1].value() - 0.6))) 
      + exp(20 * (-(x[0].value() + 0.6) * (x[0].value() + 0.6) - (x[1].value() - 0.6) * (x[1].value() - 0.6))) 
      + exp(20 * (-(x[0].value() - 0.6) * (x[0].value() - 0.6) - (x[1].value() + 0.6) * (x[1].value() + 0.6))) 
      + exp(20 * (-(x[0].value() + 0.6) * (x[0].value() + 0.6) - (x[1].value() + 0.6) * (x[1].value() + 0.6)));
    NOMAD::Double f2 = 2 * exp(20 * (-x[0].value() * x[0].value() - x[1].value() * x[1].value())) 
      + exp(20 * (-(x[0].value() - 0.4) * (x[0].value() - 0.4) - (x[1].value() - 0.6) * (x[1].value() - 0.6))) 
      - exp(20 * (-(x[0].value() + 0.5) * (x[0].value() + 0.5) - (x[1].value() - 0.7) * (x[1].value() - 0.7))) 
      - exp(20 * (-(x[0].value() - 0.5) * (x[0].value() - 0.5) - (x[1].value() + 0.7) * (x[1].value() + 0.7))) 
      + exp(20 * (-(x[0].value() + 0.4) * (x[0].value() + 0.4) - (x[1].value() + 0.8) * (x[1].value() + 0.8)));
...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    p.set_HISTORY_FILE("Far1_bimads.txt");
    p.set_STATS_FILE("test_Far1.txt", "BBE OBJ");
