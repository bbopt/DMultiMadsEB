...
/*                  Jin1                */
/*----------------------------------------*/
class Jin1 : public Multi_Obj_Evaluator
{

    public:
        Jin1(const NOMAD::Parameters &p) : NOMAD::Multi_Obj_Evaluator(p) {}
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        p.set_HISTORY_FILE("Jin1_bimads.txt");
        p.set_STATS_FILE("test_Jin1.txt", "BBE OBJ");
