...
/*                  Jin2                */
/*----------------------------------------*/
class Jin2 : public Multi_Obj_Evaluator
{

    public:
        Jin2(const NOMAD::Parameters &p) : NOMAD::Multi_Obj_Evaluator(p) {}
                ...
                bool &count_eval) const
        {
            ...
            NOMAD::Double f2 = g * (1.0 - sqrt(f1.value() / g.value()));
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        p.set_HISTORY_FILE("Jin2_bimads.txt");
        p.set_STATS_FILE("test_Jin2.txt", "BBE OBJ");
