...
/*                  Jin3                */
/*----------------------------------------*/
class Jin3 : public Multi_Obj_Evaluator
{

    public:
        Jin3(const NOMAD::Parameters &p) : NOMAD::Multi_Obj_Evaluator(p) {}
                ...
                bool &count_eval) const
        {
            ...
            NOMAD::Double f2 = g * (1.0 - (f1 / g) * (f1 / g));
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        p.set_HISTORY_FILE("Jin3_bimads.txt");
        p.set_STATS_FILE("test_Jin3.txt", "BBE OBJ");
