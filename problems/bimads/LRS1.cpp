...
/*                  LRS1                */
/*----------------------------------------*/
class LRS1 : public Multi_Obj_Evaluator
{

public:
    LRS1(const NOMAD::Parameters &p) : NOMAD::Multi_Obj_Evaluator(p) {}
                ...
                bool &count_eval) const
    {
        ...
        NOMAD::Double f2 = (x[0] + 2) * (x[0] + 2) + x[1] * x[1];
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        NOMAD::Point lb(n, -50.0);
        NOMAD::Point ub(n, 50.0);
        ...
        p.set_HISTORY_FILE("LRS1_bimads.txt");
        p.set_STATS_FILE("test_LRS1.txt", "BBE OBJ");
