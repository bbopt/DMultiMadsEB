...
/*                  Lovison2                */
/*----------------------------------------*/
class Lovison2 : public Multi_Obj_Evaluator
{

public:
    Lovison2(const NOMAD::Parameters &p) : NOMAD::Multi_Obj_Evaluator(p) {}
                ...
                bool &count_eval) const
    {
        ...
        NOMAD::Double f1 = -x[1];
        NOMAD::Double f2 = (x[1] - x[0] * x[0] * x[0]) / (x[0] + 1);
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        p.set_HISTORY_FILE("Lovison2_bimads.txt");
        p.set_STATS_FILE("test_Lovison2.txt", "BBE OBJ");
