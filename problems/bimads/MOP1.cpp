...
/*                  MOP1                */
/*----------------------------------------*/
class MOP1 : public Multi_Obj_Evaluator {

    public:
        MOP1  ( const NOMAD::Parameters & p ) :
        ...
        {
            NOMAD::Double f1 = x[0] * x[0] ;
            NOMAD::Double f2 = (x[0] - 2) * (x[0] - 2); 
...
int main ( int argc , char ** argv ) {
    ...
    try {
        ...
        NOMAD::Point lb(n, -100000);
        NOMAD::Point ub(n, 100000);
        ...
        p.set_HISTORY_FILE("MOP1_bimads.txt");
        p.set_STATS_FILE("test_MOP1.txt", "BBE OBJ");
