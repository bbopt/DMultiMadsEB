...
/*                  SSFYY1                */
/*----------------------------------------*/
class SSFYY1 : public Multi_Obj_Evaluator
{

public:
    SSFYY1(const NOMAD::Parameters &p) : NOMAD::Multi_Obj_Evaluator(p) {}
                ...
                bool &count_eval) const
    {
        ...
        NOMAD::Double f2 = (x[0] - 1) * (x[0] - 1) + (x[1] - 2) * (x[1] - 2);
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        p.set_HISTORY_FILE("SSFYY1_bimads.txt");
        p.set_STATS_FILE("test_SSFYY1.txt", "BBE OBJ");
