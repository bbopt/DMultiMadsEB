...
/*                  SSFYY2:::w                */
/*----------------------------------------*/
class SSFYY2 : public Multi_Obj_Evaluator
{

public:
    SSFYY2(const NOMAD::Parameters &p) : NOMAD::Multi_Obj_Evaluator(p) {}
    ...
    {
        NOMAD::Double f1 = 10 + x[0] * x[0] - 10 * cos(x[0].value() * PI / 2);
        NOMAD::Double f2 = (x[0] - 4) * (x[0] - 4);
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        NOMAD::Point lb(n, -100);
        NOMAD::Point ub(n, 100);
        ...
        p.set_HISTORY_FILE("SSFYY2_bimads.txt");
        p.set_STATS_FILE("test_SSFYY2.txt", "BBE OBJ");
