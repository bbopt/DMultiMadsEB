...
/*                  Sch1                */
/*----------------------------------------*/
class Sch1 : public Multi_Obj_Evaluator
{

public:
    Sch1(const NOMAD::Parameters &p) : NOMAD::Multi_Obj_Evaluator(p) {}
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        p.set_HISTORY_FILE("Sch1_bimads.txt");
        p.set_STATS_FILE("test_Sch1.txt", "BBE OBJ");
