...
/*                  VU2                */
/*----------------------------------------*/
class VU2 : public Multi_Obj_Evaluator
{

public:
    VU2(const NOMAD::Parameters &p) : NOMAD::Multi_Obj_Evaluator(p) {}
    ...
    {
        NOMAD::Double f1 = x[0] + x[1] + 1;
        NOMAD::Double f2 = x[0] * x[0] + 2 * x[1] - 1;
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        p.set_HISTORY_FILE("VU2_bimads.txt");
        p.set_STATS_FILE("test_VU2.txt", "BBE OBJ");
