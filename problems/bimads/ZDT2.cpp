...
/*                  ZDT2                */
/*----------------------------------------*/
class ZDT2 : public Multi_Obj_Evaluator {

    public:
        ZDT2  ( const NOMAD::Parameters & p ) : NOMAD::Multi_Obj_Evaluator ( p ) 
    {}
...
int main ( int argc , char ** argv ) {
    ...
    try {
        ...
        p.set_HISTORY_FILE("ZDT2_bimads.txt");
        p.set_STATS_FILE("test_ZDT2.txt", "BBE OBJ");
