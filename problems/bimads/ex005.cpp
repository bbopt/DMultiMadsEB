...
/*                  Deb53                */
/*----------------------------------------*/
class ex005 : public Multi_Obj_Evaluator
{

public:
  ex005(const NOMAD::Parameters &p) : NOMAD::Multi_Obj_Evaluator(p) {}
...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    p.set_HISTORY_FILE("ex005_bimads.txt");
    p.set_STATS_FILE("test_ex005.txt", "BBE OBJ");
